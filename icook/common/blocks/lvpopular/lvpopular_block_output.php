<?php if($this->display_type==LvpopularBlock::DISPLAY_TYPE_HOMEPAGE) : ?>
	<?php if ($this->content_list != null) : ?>
		<?php
				//So I get the first content list and want to return as a Data Provider
                $content_list_data_provider = LvpopularBlock::getContentList($this->content_list[0], null , null, ConstantDefine::CONTENT_LIST_RETURN_DATA_PROVIDER);
                ...
                if (isset($content_list_data_provider) && $content_list_data_provider != null) : ?>
                    	...
                    	$this->widget('zii.widgets.CListView',
                                  ...
                                  (
                                    ...
                                    'itemView'=>'common.blocks.lvpopular.item_render',
                                    'summaryText'=>'',
                                    'ajaxUpdate'=>true,
