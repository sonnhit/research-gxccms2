...
class Environment {
   ...
   private function _development () {
          ...
          define('SITE_PATH','http://icook.vn/');
          define('RESOURCE_URL','http://resources.icook.vn/');
          ...
          return array(
               ...
               'components' => array(
                  ...
                  // Database
                    'db'=>array(
                    'connectionString' => 'mysql:host=localhost;dbname=icook',
   ...
   private function _test() {
      ...
      define('SITE_PATH','http://icook.vn/web/');
      define('RESOURCE_URL','http://icook.vn/resources');
      define('RESOURCES_FOLDER',dirname(dirname(dirname(dirname(__FILE__)))).DIRECTORY_SEPARATOR.'resources');
